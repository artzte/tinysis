  ...
  $.fn.gradesheet = function() { 
    this.each(function(index) {
      try {
        ...
        var gradesheet_cels = that.tb_grades.find('td.a');
      
        gradesheet_cels.bind('tiny_gradesheet_send', function(event) {
        ...
        gradesheet_cels.bind('tiny_gradesheet_note', function() {
          var td = $(this);
        ...
        gradesheet_cels.bind('tiny_gradesheet_update_from_turnin_form', function() {
          var mb = $('#MB_content');
        ...
        gradesheet_cels.bind('tiny_gradesheet_update', function(event) {
          var el = $(this);
        ...
        gradesheet_cels.bind('tiny_gradesheet_nav_to', function(event) {
          var td = $(this);
          if(event.input) {
        ...
        // Cel gets focus
        gradesheet_cels.bind('tiny_gradesheet_cel_focus', function() {
          var td = $(this);
        ...
        gradesheet_cels.bind('tiny_gradesheet_cel_edit', function() {
          var el = $(this);
        ...
        gradesheet_cels.click(function(event) {
          var el = $(this);
        ...
        gradesheet_cels.find('input').live('tiny_gradesheet_close_edit', function(event) {
        ...
        // Initialize the page and master object variables
        UI.show_progress();
