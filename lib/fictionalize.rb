...
Yotov Younan Young Zeldin Zettner Ziegler Zitterkopf Zucker
  ...
  def fictionalize(collection, first_name, last_name)
    ...
    collection.each do |o|
      puts "fictionalizing #{o.login}"
      o[first_name] = fn[rand(fn.length)]
      o[last_name] = ln[rand(ln.length)]
      o.coordinator = User.find_by_email("artzte@baddabigboom.com") if o.privilege == User::PRIVILEGE_STUDENT && o.coordinator_id == nil
      o.save!
    end
